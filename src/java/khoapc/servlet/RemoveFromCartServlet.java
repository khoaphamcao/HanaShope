...
public class RemoveFromCartServlet extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(RemoveFromCartServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if(session != null){
                ...
                if(cart != null){
                    String[] items = request.getParameterValues("checkItems");
                    if(items != null){
                        for (String item : items) {
                            cart.removeFoodFromCart(item);
                        }
