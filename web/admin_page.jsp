<%-- 
    Document   : admin_page
    Created on : Jan 11, 2021, 8:58:57 AM
    Author     : Khoa Pham
--%>
                    ...
                    <c:forEach var="dto" items="${result}" varStatus="counter">
                        ...
                        <form action="DispatchServlet" method="POST">
                            <tr>
                                ...
                                <td> ${dto.quantity} <input type="hidden" name="quantity" value="${dto.quantity}" /> </td>
                                <td> 
                                    ...
                                    <c:if test="${dto.status == false}">
                                        Not active
                                    </c:if>  <input type="hidden" name="status" value="${dto.status}" />
                                </td>
                                <td> 
